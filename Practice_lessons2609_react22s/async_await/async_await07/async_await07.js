...
const getTweetDetails = async() => {
    ...
    const res = await fetch("https://programmingjs-90a13-default-rtdb.europe-west1.firebasedatabase.app/tweet.json");
    const data = await res.json();
    console.log(data.author.details.firstName + ' ' +data.author.details.lastName );
